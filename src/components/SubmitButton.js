    ...
    const handleSubmission = async (data) => {
        ...
        try {
            ...
            if (duplicateCheckResponse.status === 200) {
                ...
                alert(
                    "Question with the same title already exists. Please choose a different title."
                );
            } else {
            ...
            if (error.response && error.response.status === 404) {
                ...
                alert(
                    "You do not have the required permissions to add questions."
                );
            }
        }
                ...
                <Grid container spacing={1}>
                    ...
                    <Grid xs={12} item>
                        <TextField
                            ...
                            name="Message"
                            multiline
                            placeholder="Enter Question Content (in html)"
                            variant="filled"
                            fullWidth
